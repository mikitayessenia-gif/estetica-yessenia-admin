  ...
  turnos.forEach(t => {
    ...
    const clientSection = t.clienteNombre
      ? `<div class="turn-client-row">
          ...
          ${t.clienteTelefono ? `<a href="https://wa.me/${t.clienteTelefono}" target="_blank" class="whatsapp-link"><i class="fa-brands fa-whatsapp"></i></a><span style="font-size:0.75rem;color:#999;font-style:italic;margin-left:4px">${t.clienteTelefono}</span>` : ''}
          ${origenBadge}
        </div>`
