...
function waPhone(raw) {
  ...
  // Ya tiene código de país (54, 55, 1, etc.)
  if (/^(5[45]|1|44|3[459]|6[123468]|7|8|2[1-7]|3[0-9])/.test(n)) return n;
  // Argentino sin código → agregar 549
  if (n.length >= 10 && n.startsWith('1')) return '549' + n;
  return n;
}
